...
export const CHANGELOG = {
  ...
  entries: [
    ...
    { date: "2026-09-12", title: "Rigor that watches itself", body: "A graph of the repo's own skills, commands, hooks, and decision records now rebuilds at the start and end of every session and reports any reference pointing at a file that no longer exists, so a routine rename surfaces on its own. The rigor layer had only ever recorded what was invoked; this is the first piece of it that is triggered." },
